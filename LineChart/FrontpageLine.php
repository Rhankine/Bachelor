<?php
    ...
    if(isset($_GET['pushed'])){
        ...
        $content = "LineID,trialno,AnswerDep,AnswerVal,Smallest Datapoint,Percent,Extend,Strategy,Liked,Improvement,Comments,age,education,Country,UserId,StartTime,EndTime,AttentionQuestion\n";
